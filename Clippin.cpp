           ...
           for(int index=0;index<4;index++)
           {
                   if(index==0) //left clipping
                   {
                           for(j=0;j<m;j++)
                           {
                                ...
                                else if(!(left_below(e[j].xc,xmin))&&!(left_below(e[j+1].xc,xmin)))//both points are outside
                                {cout<<"\nj:  "<<j;
                                }
                   ...
                   if(index==1)
                   {
                           ...
                           for(j=0;j<m-1;j++)
                           {
                                ...
                                if(!(left_below(out[j].yc,ymin))&&(left_below(out[j+1].yc,ymin))) //right edge
                                {
...
void draw_window()
{
 ...
 void draw_winoutput()
 {
            wino[0][0]=win[0][0]; //before clipping
            wino[1][0]=win[1][0];
            wino[2][0]=win[2][0];
            wino[3][0]=win[3][0];
            wino[0][1]=win[0][1]-250; //after clipping
